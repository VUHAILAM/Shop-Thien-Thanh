<%-- 
    Document   : UpdateForm
    Created on : Jul 23, 2019, 12:19:17 AM
    Author     : ADMIN
--%>
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="UpdateServlet" method="post">
                        <span class="login100-form-title">
                            Customer Update
                        </span>
                        <div class="wrap-input100 validate-input m-b-16" >
                            <input class="input100" type="text" name="username" value="<%=a.getAccount()%>" readonly required>
                            <span class="focus-input100"></span>
                        </div>
                        <div class="wrap-input100 validate-input m-b-16" >
                            <input class="input100" type="text" name="fullname" value="<%=a.getName()%>" required>
                            <span class="focus-input100"></span>
                        </div>
                        
                        <div class="wrap-input100 validate-input m-b-16" >
                            <input class="input100" type="email" name="email" value="<%=a.getEmail()%>" required>
                            <span class="focus-input100"></span>
                        </div>
                        
                        <div class="wrap-input100 validate-input m-b-16" >
                            <input class="input100" type="number" name="phone" value="<%=a.getPhone()%>" required>
                            <span class="focus-input100"></span>
                        </div>
                        
                        <div class="wrap-input100 validate-input m-b-16" >
                            <input class="input100" type="text" name="job" value="<%=a.getJob()%>" required>
                            <span class="focus-input100"></span>
                        </div>
                        
                        <div class="wrap-input100 validate-input m-b-16">
                            <input class="input100" type="text" name="other" value="<%=a.getOther()%>">
                            <span class="focus-input100"></span>
                        </div>
